...
{
    public class GenerateServiceFileCodeBehindTaskContainerBuilder
    {
        public IObjectContainer BuildRootContainer(
            ...
            GenerateServiceFileCodeBehindTaskConfiguration generateFeatureFileCodeBehindTaskConfiguration)
        {
            ...
            objectContainer.RegisterTypeAs<GenerateServiceFileCodeBehindTaskExecutor, IGenerateServiceFileCodeBehindTaskExecutor>();
