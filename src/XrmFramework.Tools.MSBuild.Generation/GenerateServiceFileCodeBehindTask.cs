...
{
    public class GenerateServiceFileCodeBehindTask : Task
    {
        public IServiceFileCodeBehindGenerator CodeBehindGenerator { get; set; }
        ...
        {
            var generateFeatureFileCodeBehindTaskContainerBuilder = new GenerateServiceFileCodeBehindTaskContainerBuilder();
            ...
            var generateFeatureFileCodeBehindTaskConfiguration = new GenerateServiceFileCodeBehindTaskConfiguration(AnalyticsTransmitter, CodeBehindGenerator);
            ...
            using (var taskRootContainer = generateFeatureFileCodeBehindTaskContainerBuilder.BuildRootContainer(Log, generateFeatureFileCodeBehindTaskInfo, msbuildInformationProvider, generateFeatureFileCodeBehindTaskConfiguration))
            {
                ...
                {
                    var taskExecutor = taskRootContainer.Resolve<IGenerateServiceFileCodeBehindTaskExecutor>();
