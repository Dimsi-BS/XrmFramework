...
[$RootKey$\KeyBindingTables\{daf0243f-90f0-4888-b3ab-0763f0593cbe}]
@="#1"
...
XrmFramework_VisualStudioExtensionUI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_XrmFramework_VisualStudioExtensionLib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_XrmFramework_VisualStudioExtensionCmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_XrmFramework_VisualStudioExtensionEditorDocument, LastMacro, eLastMacroNone> m_Recorder;
