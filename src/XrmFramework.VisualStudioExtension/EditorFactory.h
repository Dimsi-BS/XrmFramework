...
/***************************************************************************
XrmFramework.VisualStudioExtension.pkgdef contains:


[$RootKey$\Editors\{1057d6df-f118-43f4-9228-51db7f9d5104}]
@="Table Editor"
"Package"="{da8f8afb-5a65-43c0-8497-85cd779b8750}"
"DisplayName"="Table Editor"
"ExcludeDefTextEditor"=dword:00000001
"AcceptBinaryFiles"=dword:00000000

[$RootKey$\Editors\{1057d6df-f118-43f4-9228-51db7f9d5104}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{1057d6df-f118-43f4-9228-51db7f9d5104}\Extensions]
"table"=dword:00000032

which informs the shell that XrmFramework_VisualStudioExtensionPackage is the package to create to have this editor 
registered with Visual Studio.  When XrmFramework_VisualStudioExtensionPackage is sited by Visual Studio, 
XrmFramework_VisualStudioExtensionPackage::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
		...
		VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
	{
		if(physicalViewId == Primary)
		{
			...
			rpguidCommandUI = &CLSID_XrmFramework_VisualStudioExtensionEditorDocument;
