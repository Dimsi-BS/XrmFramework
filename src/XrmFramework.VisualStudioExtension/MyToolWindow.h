...
class XrmFramework_VisualStudioExtensionWindowPane :
	public CComObjectRootEx<CComSingleThreadModel>,
	public VsWindowPaneFromResource<XrmFramework_VisualStudioExtensionWindowPane, IDD_XrmFramework_VisualStudioExtension_DLG>,
	public VsWindowFrameEventSink<XrmFramework_VisualStudioExtensionWindowPane>,
...
{
	VSL_DECLARE_NOT_COPYABLE(XrmFramework_VisualStudioExtensionWindowPane)

protected:

	// Protected constructor called by CComObject<XrmFramework_VisualStudioExtensionWindowPane>::CreateInstance.
	XrmFramework_VisualStudioExtensionWindowPane() :
...
BEGIN_COM_MAP(XrmFramework_VisualStudioExtensionWindowPane)
...
BEGIN_MSG_MAP(XrmFramework_VisualStudioExtensionWindowPane)
...
END_MSG_MAP()
	...
	{
		VsWindowFrameEventSink<XrmFramework_VisualStudioExtensionWindowPane>::SetSite(GetVsSiteCache());
...
class XrmFramework_VisualStudioExtensionToolWindow :
	public VSL::ToolWindowBase<XrmFramework_VisualStudioExtensionToolWindow>
{
public:
	...
	XrmFramework_VisualStudioExtensionToolWindow(const PackageVsSiteCache& rPackageVsSiteCache):
	...
	IUnknown* GetViewObject()
	{
		...
		CComObject<XrmFramework_VisualStudioExtensionWindowPane>* pViewObject;
		VSL_CHECKHRESULT(CComObject<XrmFramework_VisualStudioExtensionWindowPane>::CreateInstance(&pViewObject));
