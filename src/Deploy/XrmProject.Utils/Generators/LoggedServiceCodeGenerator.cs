...
namespace XrmProject.Utils.Generators
{
    public class LoggedServiceCodeGenerator : CodeGeneratorBase
    {
        ...
        {
            var namespaces = new List<string> { "System.Diagnostics", "System" };
            ...
            var isIService = serviceType.Name == "IService";
        ...
        private void GenerateMethodSignature(MethodInfo m, IndentedStringBuilder builder, bool displayTypes)
        {
            ...
            foreach (var p in m.GetParameters())
            {
                ...
                {
                    builder
                        .Append(_code.Reference(p.ParameterType))
                        .Append(" ");
                }
