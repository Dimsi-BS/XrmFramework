...
namespace XrmFramework.Analyzers.Helpers
{
    public class LoggedServiceCodeGenerator : CodeGeneratorBase
    {
        public string Generate(ITypeSymbol serviceType)
        {
            ...
            var baseClassName = !isIService ? "LoggedIService" : "LoggedServiceBase";

            if (!isIService) {
                foreach (var interfaceType in serviceType.Interfaces
                             .Where(t => t.ImplementsIService()))
                {
                    namespaces.Add(interfaceType.ContainingNamespace.GetFullMetadataName());
                    
                    baseClassName = $"Logged{interfaceType.Name}";
                }
            }
        ...
        private static void GenerateMethodSignature(IMethodSymbol m, IndentedStringBuilder builder, bool displayTypes)
        {
        ...
        private static void GetMethodLog(IMethodSymbol method, bool start, IndentedStringBuilder builder)
        {
            builder
                .Append("Log(")
                .Append("nameof(")
        ...
        private static void GetParametersCheck(IMethodSymbol method, IndentedStringBuilder builder)
        {
