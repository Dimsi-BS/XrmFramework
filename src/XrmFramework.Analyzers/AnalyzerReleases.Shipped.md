...
--------|----------|----------|--------------------
XRM0002  | Naming |  Error    | CallbackVisibilityRuleAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0002)
XRM0003  |  Syntax   | Error | PluginVisibilityRuleAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0003)
XRM0010  |  Syntax  |  Error | AddStepCheckRulesAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0010)
XRM0011  |  Syntax   | Warning | AddStepCheckRulesAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0011)
XRM0012  |  Syntax   | Warning | AddStepCheckRulesAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0012)
XRM0013  |  Syntax   | Error | AddStepCheckRulesAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0013)
XRM0014  |  Syntax   | Error | AddStepCheckRulesAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0014)
XRM0200  |  Syntax   | Error | CrmEntityRuleAnalyzer, [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm0200)
...
XRM1011 | XrmFramework.Generators | Error | Invalid model extension — emitted when an ExtendBindingModel property names no model, one no .model file declares, or one targeting another table. [Documentation](https://github.com/Dimsi-BS/XrmFramework/blob/main/docs/Analyzers.md#xrm1011)
