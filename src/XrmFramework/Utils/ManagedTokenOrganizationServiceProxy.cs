...
namespace XrmFramework
{
    internal sealed class ManagedTokenOrganizationServiceProxy : OrganizationServiceProxy
    {
        ...
        protected override void AssociateCore(string entityName, Guid entityId, Microsoft.Xrm.Sdk.Relationship relationship, EntityReferenceCollection relatedEntities)
        {
            var retryCount = 0;
            var securityFailed = false;
            while (true)
        ...
        protected override void DisassociateCore(string entityName, Guid entityId, Microsoft.Xrm.Sdk.Relationship relationship, EntityReferenceCollection relatedEntities)
        {
            var retryCount = 0;
            var securityFailed = false;
            while (true)
