...
namespace XrmFramework.RemoteDebugger.Converters
{
    ...
    {
        private readonly DataCollectionConverter<Microsoft.Xrm.Sdk.Relationship, QueryBase> _internalConverter = new DataCollectionConverter<Microsoft.Xrm.Sdk.Relationship, QueryBase>();
    ...
    {
        private readonly DataCollectionConverter<Microsoft.Xrm.Sdk.Relationship, EntityCollection> _internalConverter = new DataCollectionConverter<Microsoft.Xrm.Sdk.Relationship, EntityCollection>();
