...
#pragma warning disable XRM0300
            return Convert.ToString(Convert.ToInt64(DateTime.UtcNow.Add(timeToLive).Subtract(SharedAccessSignatureTokenProvider.EpochTime).TotalSeconds, CultureInfo.InvariantCulture), CultureInfo.InvariantCulture);
