...
namespace XrmFramework.DeployUtils.Generators
{
    ...
    public class CSharpHelper : ICSharpHelper
    {
        ...
        public string Reference(Type type, bool useFullName)
        {
            ...
            {
                builder
                    .Append(Reference(type.GetElementType(), useFullName))
                    .Append("[");
            ...
            if (type.IsNested && !type.IsGenericParameter)
            {
                ...
                builder
                    .Append(Reference(type.DeclaringType, useFullName))
                    .Append(".");
            }
        ...
        public virtual string UnknownLiteral(object value)
        {
            ...
            throw new InvalidOperationException($"Cannot scaffold this literal '{literalType}'");
        }
