...
public class RegistrationService : IRegistrationService
{
	...
	public RegistrationService(string connectionString)
    {
        ...
        _client = new Microsoft.Xrm.Tooling.Connector.CrmServiceClient(connectionString);
#else
        _client = new Microsoft.PowerPlatform.Dataverse.Client.ServiceClient(connectionString);
#endif
    }
